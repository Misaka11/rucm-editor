...
module.exports = Promise.resolve()
    ...
    .then(function () { return import('rucm-editor-extension/lib/browser/rucm-editor-frontend-module').then(load) })
    .then(function () { return import('rucm-server/lib/browser/rucm-server-frontend-module').then(load) })
